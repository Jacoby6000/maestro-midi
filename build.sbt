...
lazy val publishSettings = osgiSettings ++ Seq(
  ...
  homepage := Some(url("https://github.com/jacoby6000/maestro-midi")),
  apiURL := Some(url("https://github.com/jacoby6000/maestro-midi/tree/master")),
